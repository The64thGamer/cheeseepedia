...
The **[[File:New Graphic.png]]** graphic should be placed on any segments that are entirely new and are not re-used. If the segment has a mix of new and re-used elements, then specifically label the songs instead.
#**Intermission 1**
