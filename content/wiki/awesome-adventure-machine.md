...
+++
The ***Awesome Adventure Machine,*** also known internally as 'Stage 2000,' was a test stage that was installed at {{< wiki-link "Dallas, TX (13125 Montfort Dr)" >}}.
This was the first attempt by CEC to create a stage centered around only one animatronic character. To make up for the absence of the other characters, the other cast was featured in walkaround form with articulated heads that interact in show segments, and a major focus was placed on video elements.
...
About 500 individual pieces were scattered around the show area. Behind Chuck E. were moving background objects, given that the main concept of the show was that Chuck E., his friends, and the kids built the machine out of junk. The items included were everyday household items like wheels, scales, trash cans, an iron, a basketball, water bottles, and plastic, among other things.

### Lighting

The Awesome Adventure Machine featured a lot of bright lighting effects. The screen to the left of Chuck E's stage had a lighted zig-zag pattern, and the screen to the right had a lighted gear-shaped pattern. There was also an American DJ 'Laser Widow', behind the right screen that would create shapes on the screen.{{< cite 1 >}} Above the screens and leading into Chuck E.'s stage were several sets of twisted neon lights, which appeared to be electrical currents when programmed to quickly flash back and forth.
Several lighting effects appeared from inside Chuck E.'s chamber as well, and above Chuck E. was an LED board that could spell out messages and display designs.

## Props / Supporting Characters

Along with Chuck E. Cheese, the Awesome Adventure Machine featured a variety of robotic sidekicks that surrounded him and the entire show. The main 3 animatronic sidekicks were described as follows:
...
The stage premiered with {{< wiki-link "August 1996 Show (AAM)" >}}.  The next showtape, {{< wiki-link "Chuck E. Cheese's 20th Anniversary (AAM)" >}}, debuted in April 1997. Around this time, Chuck E.'s outfit was changed from pink to purple. The final Awesome Adventure Machine showtape, {{< wiki-link "August 1997 Show (AAM)" >}}, premiered in August 1997 and played until the stage's removal. The stage never received {{< wiki-link "Chuck E's Magical Holiday Celebration" >}} or {{< wiki-link "Chuck E's Jukebox Jam Show" >}}. 
The Awesome Adventure Machine test was ultimately a failure. While the general public liked the Awesome Adventure Machine show, ShowBiz executives did not. Former employees who worked at the Dallas Montfort location during the Awesome Adventure Machine period recall corporate executives coming to see the show and commenting that it was far too expensive to install across all locations. Before the Awesome Adventure Machine was installed, Dick Frank (former CEO of ShowBiz Pizza Time, Inc.) said, 'We don't need animatronic shows in our restaurants.' 
On October 23, 1997, the trademarks of all Awesome Adventure Machine content were abandoned. Between November 1997 and January 1998, the Awesome Adventure Machine show was removed from the Dallas Montfort location, and all of the parts and props of the show were thrown away and destroyed, with only the neon display sign being saved and placed on display in the corporate office until it was also thrown out years later.
After the Awesome Adventure Machine show was removed. The show was replaced with the all-new concept at the time, 'Studio C,' and the {{< wiki-link "Studio C Alpha" >}} show replaced the Awesome Adventure Machine at the original Dallas Montfort location.{{< cite 2 >}} The last appearance of Awesome Adventure Machine in any official CEC media was in Chuck E. Cheese in the Galaxy 5000 in 1999.

## Lost Media

Due to the Awesome Adventure Machine only being used briefly, there is very little documentation of many of its features, and none of its showtapes have publicly surfaced. The North Dallas news team, WFAA (Channel 8), ran a segment focused on the Awesome Adventure Machine and included footage of the Premiere show. This segment has not yet been found.
In March 2002, Brian Hagan (former Department 18 Studio Manager and Awesome Adventure Machine programmer) shared three video clips of the Awesome Adventure Machine and a picture of the full show with the public. These were the only known media of the Awesome Adventure Machine show for about 20 years, besides a newspaper clipping that contained an additional image of the show.
In August 2021, Jon Rice (former Vice President of Marketing) shared new images of the Awesome Adventure Machine, and in December 2021, Brian Hagan shared the full-length Awesome Adventure Machine footage of {{< wiki-link "Chuck E. Cheese's 20th Anniversary (AAM)" >}} with audio captured directly from the LaserDisc. 
In March 2023, audio surfaced of the Awesome Adventure Machine premiere invitation that was presumably only sent out to managers & employees in the Dallas & Fort Worth, Texas areas. No pictures or videos have surfaced of the invitational premiere.
In 2025, more Awesome Adventure Machine media was found, including two photos that show the center stage, with one taken in 1996 or early 1997, while the other was taken in October 1997. In December 2025, a home video of the Awesome Adventure Machine would be uploaded onto YouTube, which was filmed in October 1996. The footage showcases the Pre-Show segment that would play right before Segment 1. This Pre-Show segment was exclusive to the AAM version of the August 1996 Show.
