...
+++
.]]
The **_CEI Laserdisc**_ was a prototype showtape format created by _Creative Engineering_ in 1983 for the [Dr. Juke]({{< ref "wiki/Dr Juke.md" >}}){< ref "wiki/Dr Juke.md" >}}) _Rock-afire Explosion_ Show Selector, featuring interactive touchscreen video elements when showtapes were not playing.

Despite Laserdisc's video capabilities, the need to provide four audio channels for a [Grey Box]({{< ref "wiki/Grey Box.md" >}}) showtape meant the video needed to be taken up by PCM audio signals. Video was still possible when a show was not playing, being the main use for the format alongside using _Random Access Memory to grab frames of the video._
