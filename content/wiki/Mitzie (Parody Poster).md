...
gallery = []
+++
{{Art|image=Mitzie.png|releasedate=1988|finalrelease=1990|text1=What do you get when you cross a typical teenaged cheerleader with a dynamite red sequined dress?|text2=You get America's hottest new singer!|text3=MITZI MOZZERELLA
Mitzie|text4=Showbiz Parodies Presents a Mirror/Image production HY SKOOL CATHY TERIA PEPPER RALLY in 'MITZIE'
Music by BEN DLEEDR Original Lyrics by T. CHARZPET Sung by Mitzi Mozzarella Executive Producer Ring Binder
Story by LES HOMEWORK Screenplay by MITZI BUSS & SKIP CLASS Produced by OTTO TORIUM|text5=A Showbiz Pizza Time Parody Poster Production Â© 1986 ShowBiz Pizza Time, Inc.|dimensions=36in x 24in}}

The <b><i>Mitzie</b></i> was a poster created for <i>Showbiz Pizza</i> and <i>Chuck E. Cheese's</i> in <i>1988</i>.
