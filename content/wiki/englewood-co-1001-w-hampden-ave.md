...
+++
***1001 W Hampden Ave, Store #721* was a ShowBiz Pizza Place that opened on July 16, 1981 as a corporate *ShowBiz Pizza Place* with a {{< wiki-link "Classic Stage" >}}.**
...
In 1991/1992, Englewood received {{< wiki-link "Concept Unification" >}}, converting the Rock afire into Munch's Make Believe Band.
Sometime in around Early-Mid 2000, Englewood removed the 3-Stage for the Studio C Alpha stage.

  Stage                                                                                           Installed       Removed         Notes
  ----------------------------------------------------------------------------------------------- --------------- --------------- --------------------------------------------------------
  {{< wiki-link "Classic Stage" >}}                                                           July 1981       1991 or 1992    3rd ShowBiz Pizza in Colorado.
  {{< wiki-link "Concept Unification Stage" >}}                                               1991 or 1992    Early 2000      One of 5 Colorado locations to get Concept Unification
...
## Animatronics
  ...
  --------------------------------------------------------------------- ----------- -------------------
  {{< wiki-link "Rolfe Dewolfe & Earl Schmerle (Animatronic)" >}}   1-81 1-6    Unknown/Destroyed
  {{< wiki-link "Dook Larue (Animatronic)" >}}                      1-81 2-6    Unknown/Destroyed
  {{< wiki-link "Fatz Geronimo (Animatronic)" >}}                   1-81 3-6    Unknown/Destroyed
  {{< wiki-link "Beach Bear (Animatronic)" >}}                      1-81 4-6    Unknown/Destroyed
  {{< wiki-link "Mitzi Mozzarella (Animatronic)" >}}                1-81 5-6    Unknown/Destroyed
  {{< wiki-link "Billy Bob (Animatronic)" >}}                       1-81 6-6    Unknown/Destroyed
  {{< wiki-link "Looney Bird (Animatronic)" >}}                     1-81 7-6    Unknown/Destroyed
  {{< wiki-link "Choo Choo (Animatronic)" >}}                       1-81 8-6    Unknown/Destroyed
  {{< wiki-link "Sun (Animatronic)" >}}                             1-81 10-6   Unknown/Destroyed
  {{< wiki-link "Moon (Animatronic)" >}}                            1-81 11-6   Unknown/Destroyed
  {{< wiki-link "Antioch (Animatronic)" >}}                         N/A         Unknown/Destroyed
  {{< wiki-link "Wink" >}}                                          N/A         Unknown/Destroyed
  {{< wiki-link "Chuck E Cheese 32m (Animatronic)" >}}              066         Destroyed
  {{< wiki-link "Bird (Animatronic)" >}}                            N/A         Destroyed
  {{< wiki-link "Pizza Time Clock (Animatronic)" >}}                N/A         Destroyed
  {{< wiki-link "Pizza Phone (Animatronic)" >}}                     N/A         Destroyed

[Englewood as ShowBiz Pizza Place](https://www.showbizpizza.com/photos/spp/co_englewood/index.html)
[Englewood CO before the 2005 Remodel and after removal of 3-Stage](https://www.flickr.com/photos/skessler/albums/72157604498713792)
