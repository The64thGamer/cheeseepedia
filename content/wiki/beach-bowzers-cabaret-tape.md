...
contributors = ["The 64th Gamer","CoolerDude","Ceclife13"]
citations = []
...
1. **Segment 2**
    1.  ['409'](https://en.wikipedia.org/wiki/409_(song))
2. **Segment 3**
    1.  ['Little Honda'](https://en.wikipedia.org/wiki/Little_Honda)
3. **Segment 4**
    1.  ['Fun, Fun, Fun'](https://en.wikipedia.org/wiki/Fun,_Fun,_Fun)
4. **Segment 5**
    1.  ['Don't Back Down'](https://en.wikipedia.org/wiki/Don%27t_Back_Down)
5. **Segment 6**
    1.  ['Surfin' USA'](https://en.wikipedia.org/wiki/Surfin%27_U.S.A.)
7. **Segment 7**
    1.  ['Don't Worry Baby'](https://en.wikipedia.org/wiki/Don%27t_Worry_Baby)
8. **Segment 8**
    1.  ['Surfin' Safari'](https://en.wikipedia.org/wiki/Surfin%27_Safari_(song))
9. **Segment 9**
    1.  ['In My Room'](https://en.wikipedia.org/wiki/In_My_Room)
10. **Segment 10**
    1.  ['Little Deuce Coupe'](https://en.wikipedia.org/wiki/Little_Deuce_Coupe_(song))
11. **Segment 11**
    1.  ['Hawaii'](https://en.wikipedia.org/wiki/Hawaii_(The_Beach_Boys_song))
12. **Segment 12**
    1.  ['Catch-a-Wave'](https://en.wikipedia.org/wiki/Catch_a_Wave)
13. **Segment 13**
