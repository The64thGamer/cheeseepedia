...
+++
The <b><i>CEC LRS Order Pager</b></i> is a tabletop electronic pager that vibrates to alert customers that their order is ready to pick up. The pager began to be used in Texas stores starting in 2017, before heading to other test markets in 2018, and by 2019 all stores acquired a set.

<h2> LRS </h2>
The <i>Long Range Systems LLC Guest Connect Note</i> is the pager used in the stores, being part of the <i>LRS Guest Connect Note Paging Kit</i><ref>https://shop.lrsus.com/collections/guest-paging/products/lrs-guest-pager-note-kit?variant=53442164117</ref><i>,</i> a package including 15-60 notes (It is unclear currently which count of notes stores received), a transmitter, 2 power supplies, and a lid kit for custom inserts.
