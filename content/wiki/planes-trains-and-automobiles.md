...
contributors = ["DerekCat", "BurgersNuggs445", "The 64th Gamer", "Cyber Snout", "Ceclife13", "Luigigamin212"]
...
1. **Intermission 1**
    ...
    2. CEC TV Classic ID
2. **Segment 1**
    1. ['Little Red Corvette'](https://en.wikipedia.org/wiki/Little_Red_Corvette)
    2. 'Train Ride'
3. **Intermission 2**
    ...
    3. 8 Minute Countdown
        ...
        3. ['(Everything I Do) I Do It For You'](https://en.wikipedia.org/wiki/(Everything_I_Do)_I_Do_It_for_You)
    4. CEC TV Classic ID
4. **Segment 2**
    1. ['Bicycle Built for Two'](https://en.wikipedia.org/wiki/Daisy_Bell)
    2. ['Fun, Fun, Fun'](https://en.wikipedia.org/wiki/Fun,_Fun,_Fun)
5. **Intermission 3**
    1. CEC TV Special Intro
    2. Geography Rap - 'Oceans'
    3. 8 Minute Countdown
...
6. **Segment 3**
    1. 'Goin' Sight Seein''
    2. ['Danger Zone'](https://en.wikipedia.org/wiki/Danger_Zone_(song))
7. **Intermission 4**
    1. CEC TV Special Intro
