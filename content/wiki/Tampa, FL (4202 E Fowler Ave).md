...
gallery = []
+++
{{Generic|image=Tampafllocationcitationaaron.png|desc=Newspaper Mention}}

Tampa, FL (???) is a cancelled ShowBiz Pizza Place that would have been placed near the University of South Florida, per possible request by Aaron Fechter.
