...
## [Studio C]({{< ref "wiki/Studio C.md" >}}) shows have their animation signals split onto a Floppy Disc.
...
# CEC since 2017 has spent a majority of their budget on the 2017 2.0 Remodel Program, which seeks to remove all animatronics from their locations in replacement of a video screen. Most locations with animatronics, especially the 3-Stage are disappearing. If you would like to check which locations still have a specific stage, all remaining stores are listed in each article of the :Category:Stage Variations#Chuck%20E.%20Cheese's-0 (Stage Variations).