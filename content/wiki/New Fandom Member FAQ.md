...
| style='vertical-align: top;background-color:#172441;' |Hello new user, it seems you're interested in _Pizza Time Theatre / ShowBiz Pizza Place / Chuck E. Cheese's / Creative Engineering_. This is a crash course on the fandom, the inner workings of these companies, and what you can do to help.
|style='vertical-align: top;| 
|}</div>
## What is/are? ##

* ****Data?' -**_ The community always refers to lost media as this, though this term is also used for [animation signals]({{< ref "wiki/Data.md" >}}). This is because both are synonymous with being hard to get your hands on.
* ****Showtapes?' -**_ these are a physical piece of media that contains generally 30 mins - 2 hours of musical content. They are all generally formatted to have a  hidden audio channel that passes through [animation signals]({{< ref "wiki/Data.md" >}}) to the computer for processing, which aren't usually posted online. Stores have always received new showtapes every few months for the past 40 years, and they usually just keep older tapes in a storage room or throw them away, as it is not permitted to play previous tapes. Showtapes take on different formats throughout the years:
...
* ****2.0' -**_ This is the [CEC 2018 2.0 Remodel Program]({{< ref "wiki/CEC 2018 20 Remodel Program.md" >}}) that is has been replacing all animatronic shows since 2018. Only ~50 stores are left that still contain animatronics, while just 5 are planned to keep them.
* ****Phases' -**_ This is a commonly used phrase to erroneously refer to the current remodel of a store, when it is actually a separately installed package stores could opt into. The :Category:CEC Phases & Remodels (CEC Phases & Remodels) category clears up what delineates each variant a store can be at any given time.
...
A few channels have uploaded rips of the original analogue masters for some tapes, giving much better fidelity. These are [https://www.youtube.com/@pizzacam/videos pizzacam], [https://www.youtube.com/@Pizzacam3/videos pizzacam3], and [https://www.youtube.com/@brianhagan/videos Brian Hagan]. 
