...
gallery = []
+++
{{Stub}}{{Animatronic|image=Higher quality Billy Bob.png|releasedate=|manufacturer=Creative Engineering|catalogID=}}
The Billy Bob Animatronic was one of the main [Rock-afire Explosion]({{< ref "wiki/Classic Stage.md" >}}) animatronics produced by Creative Engineering Inc. The animatronic would first be developed in April of 1980, before debuting at the [Jacksonville, FL (9820 Atlantic Blvd)]({{< ref "wiki/Jacksonville, FL (9820 Atlantic Blvd).md" >}}) on August 14th of that year.
...
Through the  [Concept Unification]({{< ref "wiki/Concept Unification.md" >}}) process, Billy Bob would be the only character not used during this process, and was ordered to be destroyed for parts.
## Design ##
