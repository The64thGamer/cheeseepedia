...
gallery = []
+++
The <b><i>Winchester Game Room Rules Sign</b></i> first appeared at the Chuck E. Cheese's Pizza Time Theatre on [370 South, Winchester Boulevard in San Jose, California;]({{< ref "wiki/San Jose, CA (370 S Winchester Blvd).md" >}}) from May 1977 to potentially the 1981 remodel.
...
The sign would be placed above the game room directly under Winchester Jasper T. Jowls (Animatronic) (Jasper T. Jowls portrait.) 

<h2> Design </h2>
The design of this sign varies from other known signs at the store, instead showcasing a brown background with red text layered on top of a second background, this time in the color yellow; the larger white text placed in between the 2 backgrounds reads 'NO' with smaller red text reading, 'FOOD OR SMOKING PERMITTED'
