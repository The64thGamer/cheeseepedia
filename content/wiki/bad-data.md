...
Oddly, some show listings will have a segment listed, crossed out, and the correct one written beside it. It is unclear if these were similar *Bad Data* incidents, a change of plans, or an initial incorrect documentation of the segment used.**

## Fixes

#### Replacement

Songs have been seen to be replaced after a *Bad Data* segment is found. Sometimes this is with the same showtape, other times this is with a different showtape.
