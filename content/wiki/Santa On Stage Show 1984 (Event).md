...
+++
##  Store Appearances ## 
One store would be confirmed to have kept Klunk from the previous [\2](\1) event. This is only by confirmation that they had the [\2](\1) event, which is presumed to always have coincided with stores<ref name=':1'>Country Klunk tape filmed there. [[:File:NorthRichlandHillsCountryKlunk.png]]</ref>

* [[North Richland Hills, TX (7935 Grapevine Hwy)]]<ref name=':1' />
