...
gallery = []
+++
{{Generic|image=Cyberamics Tester Image 1.jpg|desc=Cyberamics Tester}}
...
Two versions of the unit are known, one with black printed labels and the _Audio Out_ port in the center, and one with white labels and the port shifted to the right. It is currently unknown which variant is the revision.
