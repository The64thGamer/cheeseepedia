...
gallery = []
+++
The **_Pasqually's Perfect Pizza**_ sign first appeared at the second Chuck E. Cheese's Pizza Time Theatre on 1371 Kooser Road, installed alongside the [\2](\1) to direct users to the ordering counters, presumably until the 1981 remodel. 
...
##  Usage/Releases ## 
Very little is known about the usage of the sign, but as stated before it is theorized most signs from the era, including this sign, were store specific. The only known usage is at [\2](\1) outside of this, no other stores are known to have used this.
