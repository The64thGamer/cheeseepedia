...
gallery = []
+++
The **_1977 Helen Henny nameplate**_ was only used at the first Chuck E. Cheese's Pizza Time Theatre on  located in the Town & Country Shopping Center in San Jose, California; where it would be used to identify the newly introduced 
...
### Usage In 2.0 ###
Helen Hennys nameplate would be featured for the first time in several decades in the 2.0 remodel, where it is also shown alongside  and  in a piece of signage showing the history of the company, this time lacking 'ATARI 1977' where it was most likely edited out.
