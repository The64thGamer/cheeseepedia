...
gallery = []
+++
{{Stub}}{{Animatronic|image=RolfeDewolfe.png|releasedate=|manufacturer=Creative Engineering|catalogID=}}

The Rolfe Dewolfe & Earl Schmerle Animatronic (Also the 3-Stage Chuck E. Cheese Animatronic) was one of the main [Rock-afire Explosion]({{< ref "wiki/Classic Stage.md" >}}) animatronics produced by Creative Engineering Inc. The animatronic would first be developed in April of 1980, before debuting at the [Jacksonville, FL (9820 Atlantic Blvd)]({{< ref "wiki/Jacksonville, FL (9820 Atlantic Blvd).md" >}}) on August 14th of that year. His character was based off the Wolfman from the [Wolf Pack 5]({{< ref "wiki/Wolf Pack 5.md" >}}) animatronic show Creative Engineering had developed. 
