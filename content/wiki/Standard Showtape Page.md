...
<b><i>Show name title</b></i> is a showtape released and this is a short description on it.
...
For the info box to the right, a number of descriptors can be added that will help give info on the tape. The main ones needed are the release date and the release formats. A lot of the descriptors only need to have a single letter in their text box to appear, while others such as the <i>Release Date</i> or <i>Label</i> need to be typed out.

For PTT shows, the <i>Theme</i> and <i>Guest Star</i> descriptors in the box will need to be provided.
...
Rereleased versions also go here, but <b><i>only</b></i> if they are identical completely to the original showtape outside of labeling. Any tweaks to the performance or audio/video should instead be put under a new page.

<h2> Show List </h2>
The show list should just be a numbered list of the showtape segments in order. Generally these will be labeled as 'Segment #' and 'Song #', but certain formats like newer <i>Chuck E. Cheese</i> shows refer to segments as 'Skits', so those will be used instead. Some showtapes, such as <i>Showbiz Pizza Place</i> tapes and newer <i>Chuck E. Cheese</i> showtapes have official song lists. These will be used for the numbered lists inside the segment header. If a large segment is officially written down as '___ Medley' or  '____ Songs', another sub-list should be created listing the official song titles under it.
...
If the song is a parody song, list it like this: 'Killer (Parody of <i>[https://en.wikipedia.org/wiki/Thriller_(song) Thriller]</i>)'
...
The <b></b> graphic should be placed on any segments that are entirely new and are not re-used. If the segment has a mix of new and re-used elements, then specifically label the songs instead.
#<b>Intermission 1</b>
##[https://en.wikipedia.org/wiki/List_of_VeggieTales_videos#A_Very_Silly_Sing_Along.2FVery_Silly_Songs.21_.281997.29 Intermission Name]
##[https://en.wikipedia.org/wiki/List_of_VeggieTales_videos#A_Very_Silly_Sing_Along.2FVery_Silly_Songs.21_.281997.29 Intermission Name]
#<b></b> <b>Segment 1</b>
##[https://en.wikipedia.org/wiki/Lucille_(Little_Richard_song) <i>Song or Skit Name</i>]
##[https://en.wikipedia.org/wiki/Swingin%27_(John_Anderson_song) <i>Song or Skit Name</i>]
##Song Medley
...
#<b>Segment 2</b>
##[https://en.wikipedia.org/wiki/Lucille_(Little_Richard_song) <i>Song or Skit Name</i>]
##<b></b> [https://en.wikipedia.org/wiki/Swingin%27_(John_Anderson_song) <i>Song or Skit Name</i>]
##<b></b> [https://en.wikipedia.org/wiki/Lucille_(Little_Richard_song) <i>Song or Skit Name</i>]
<h2>Lives</h2>
