...
Most film can be run through a standard 8mm or 16mm scanner for capture. If the film is in a cartridge, such as the _PTT 1981 Training Tapes,_ which use the MPO Videotronic Super-8 cases, they can be removed from the cartridge safely and spun on a reel for capture.
