+++
draft = false
title = "CEC Rock It Into Space"
startDate = "1992-01-00"
endDate = "1992-02-00"
pageThumbnailFile = "WWawNrI7oAumfnThInXP.avif"
contributors = ["The 64th Gamer", "DerekCat", "Montfortdog", "Luigigamin212", "Ceclife13"]
credits = ["David Robinson|Show Programmer", "Scott Wilson|Voice of Chuck E. Cheese, Mr. Munch", "Karlisa Burleson|Voice of Helen Henny", "Bob West|Voice of Jasper T. Jowls, Pasqually The Chef", "Charles Stewart|Songwriter, Voice of Charlie Rockit", "Darby Orr|Songwriter"]
...
1. **Intermission 1**
   ...
   4. CEC TV Classic ID
2. **Segment 1**
   1. ['Venus'](https://en.wikipedia.org/wiki/Venus_(Shocking_Blue_song))
   2. 'Twinkle Twinkle'
3. **Intermission 2**
   1. 8 Minute Countdown
   ...
   2. CEC TV Special Intro
   3. CEC TV News - 'Pasqually On The Moon'
   4. CEC TV Classic ID
4. **Segment 2**
   1. ['Rocket Man'](https://en.wikipedia.org/wiki/Rocket_Man_(song))
   2. 'Rock It Up'
5. **Intermission 3**
   1. 8 Minute Countdown
   ...
   2. CEC TV Special Intro
   3. Geography Rap - 'Canada'
   4. CEC TV Classic ID
6. **Segment 3**
   1. ['The Purple People Eater'](https://en.wikipedia.org/wiki/The_Purple_People_Eater)
