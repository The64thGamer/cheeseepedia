...
The format is used for three specific  stages, that being the , [1-Stage]({{< ref "wiki/1-Stage.md" >}}), and [2-Stage]({{< ref "wiki/2-Stage.md" >}}), hence the 'R12'. The 'Pre-93' refers to it being of the original showtape format for Cyberstar before a switch to a new format in May of 1993 with the release of [Best of CEC TV 1993]({{< ref "wiki/Best of CEC TV 1993.md" >}}).
##Format##
...
##Showtapes##
This format was only produced for 3 years before it switched to [R12 SVHS (Post-93)]({{< ref "wiki/R12 SVHS (Post-93).md" >}}).
