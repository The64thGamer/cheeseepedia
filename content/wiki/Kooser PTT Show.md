...
+++
{{Generic|image=Kooser road portrait.jpg|desc=The Show's Portrait Stage in Kooser's Showroom, 1978}}
The **_Kooser PTT Show**_ (also known as The **_Kooser Portrait / Shelf Stage & Kooser Lounge Area**_) was a show format used at the second _[Pizza Time Theatre]({{< ref "wiki/Pizza Time Theatre.md" >}})_ on [San Jose, CA (1371 Kooser Rd)]({{< ref "wiki/San Jose, CA (1371 Kooser Rd).md" >}}) from December 1978 up until its replacement by the first [Cyberamics Balcony Stage]({{< ref "wiki/Cyberamics Balcony Stage.md" >}}) in May 1980. The show was the last non-[Cyberamics]({{< ref "wiki/Cyberamics.md" >}}) Show produced by PTT. 

## History ##

### Production ###
In Fall 1978, [Fantasy Forest]({{< ref "wiki/Fantasy Forest.md" >}}) & Harold Goldbrandsen were tasked with building the animatronic stage show for the second PTT that was being built on Kooser Road. The stage would have features not seen in [the previous stage]({{< ref "wiki/Winchester PTT Show.md" >}}), like The Mopsey Sisters & [Mr. Munch]({{< ref "wiki/Mr Munch.md" >}}). The Overall Show would also have Dolli Dimples in a Cabaret room.

### Early History ###
The Stage was delivered to Kooser in Late November & first seen at Kooser's Grand Opening in December 1978. The Stage was set in Kooser's Dining Area on 2 separate walls, unlike [Winchester]({{< ref "wiki/San Jose, CA (370 S Winchester Blvd).md" >}}) using all 4 walls. [The Dolli Animatronic]({{< ref "wiki/Kooser Dolli Dimples (Animatronic).md" >}}) was placed in a separate Cabaret Room. The Stage would be seen in several promotional papers from the time.
...
|Portrait / Shelf Stage
|-
|[Kooser Flag Wavers (Animatronic)]({{< ref "wiki/Kooser Flag Wavers (Animatronic).md" >}}) 
|December 1978-May 1980
|Portrait / Shelf Stage
|-
