...
gallery = []
+++
{{Generic|image=Sppprogram9.png|desc=Showbiz Pizza Program 9}}

**_Showbiz Pizza Program 9**_ is a music cassette released alongside Showbiz Pizza Place and Pizza Time Theatre showtapes as background music between segments. This would eventually evolve into Cyberstar, though the cassettes would still be produced for stores not yet converted to it.
