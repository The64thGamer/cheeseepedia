...
gallery = []
+++
The <b><i>Item name goes here in bold italics</b></i> was a (fixture / decoration / poster) created for (Chuck E. Cheese's, Showbiz Pizza Place, etc.) in <i>insert year</i>.
...
* Montfort 1998 Prototype: <b>Artwork originally had black borders for each piece</b>

* 2003 release: <b>Frames were added around the artwork.</b>
* 2005 release: <b>Artwork was reverted into its original state without frames.</b>
