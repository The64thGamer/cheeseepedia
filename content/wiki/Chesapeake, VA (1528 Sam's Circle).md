...
gallery = []
+++
{{Generic|desc=Chesapeake's exterior days before the begun 2.0. (PC: Google Maps)|image=Chesapeake before 2.0.jpg}}
**_Chesapeake, VA (1528 Sam's Circle), Store #3198/#550**_ is a _Chuck E. Cheese_ in Chesapeake, Virginia that opened in December 1996 with a 2-Stage and is still open with the 2.0 remodel.
