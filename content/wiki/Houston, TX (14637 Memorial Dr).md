...
<b><i>14637 Memorial Drive, Store #731</b></i> was a <i>ShowBiz Pizza Place</i> that opened on August 26th, 1981 with a [Rock-afire Explosion]({{< ref "wiki/Classic Stage.md" >}}), and closed as a <i>Chuck E Cheese's</i> on October 24th, 2012 with a [3-Stage]({{< ref "wiki/Concept Unification Stage.md" >}}). It relocated to the [Westheimer, TX]({{< ref "wiki/Houston, TX (12523 Westheimer Rd).md" >}}) store. 
<h2> History </h2>
