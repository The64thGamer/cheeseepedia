...
+++
[\2](\1)
**Winchester Pasqually** was an animatronic featured at the [\2](\1). It would be used from the location's opening until it was replaced by the standard Cyberamic model in 1980.
...
In 1980, Pasqually, along with all the other Gen 1 animatronics were removed and replaced with the standard [\2](\1) model.
[\2](\1)

###  After Removal ### 
After he was removed from the restaraunt, Pasqually was moved to [\2](\1), persumably along with the other retired Winchester animatronics. He would remain there until Pizza Time Theatre vacated the building following bankruptancy. He would be saved along with [\2](\1) and [\2](\1) by Jul Kamen.

###  Corporate Move and Destruction ### 
In the 1990's, [\2](\1) borrowed the portrait bots from Jul to use in a museum dedicated to CEC's history, the plans for which would never move forward. The bots were used as a display piece until 2004, when CEC Headquarters underwent a remodel. The bots were removed, and ordered to be destroyed, as per CEC's de-identification policy. Jasper and Pasqually were destroyed, the person responsible is speculated to be Gene Cramm, but Chuck E. Cheese was rescued by employees.