...
gallery = []
+++
The **Studio C control system** manages all elements of the animatronic show at [[Chuck E Cheese]] locations featuring the [[Studio C]] show type, in addition to controlling some ancillary equipment such as the [[Karaoke]] system (during the period in which it was being used).
...
Some Studio C documentation includes references to the video system of the [[Interactive Console]] used at [[Studio C Alpha]] locations. The video portion of the Interactive Console system is not discussed on this page as it has no direct connections to the rest of the show video control system.
