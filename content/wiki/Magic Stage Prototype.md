...
gallery = []
+++
The <i>Magic Stage</i> was a test stage made by Showbiz Pizza Place with the objective to stray away from Rock-afire Explosion branding as a result of licensing conflicts between Creative Engineering and Showbiz Pizza.
...
<h2>= Austin, TX (8038 Burnet Rd) </h2>=
Sometime later, the [Austin, TX (8038 Burnet Rd)]({{< ref "wiki/Austin, TX (8038 Burnet Rd).md" >}}) Showbiz Pizza Place would obtain the magic stage cosmetics. The stage was outfitted with each character costume and the valance (minus the 'MAGIC' lettering) until Concept Unification. 
...
<h2>= Billy Bob and Looney Bird </h2>=
...
<h2>= Mitzi Mozzarella, Beach Bear, Fatz Geronimo, Choo Choo, Dook </h2>=
...
<h2>= Rolfe Dewolfe and Earl Schmerle </h2>=
