...
gallery = []
+++
{{Generic|image=Showbiz pizza program 13.png|desc=Cassette Front}}

**_Showbiz Pizza Program 13**_ is a music cassette released alongside Showbiz Pizza Place and Pizza Time Theatre showtapes as background music between segments. This would eventually evolve into Cyberstar, though the cassettes would still be produced for stores not yet converted to it.
