...
<b><i>1661 Easton Rd B-2</b></i> is a <i>Chuck E. Cheese's</i> that opened on November 30th, 2004, with a 16m Studio C 2000. It remains open today with the CEC 2018 2.0 Remodel Program (2.0 Remodel).

<h2>Stages</h2>
This store opened with a 16m [Studio C Beta]({{< ref "wiki/Studio C Beta.md" >}}), and it would remain at the store until it was removed during the store’s [CEC 2018 2.0 Remodel Program]({{< ref "wiki/CEC 2018 20 Remodel Program.md" >}}).
{| class='wikitable'
|+
!Stage
!Installed
