...
+++
The <b><i>Navori System</b></i>, is a device that can be attached to the 3-Stage, [Cyberamics]({{< ref "wiki/Cyberamics.md" >}}), [Studio C]({{< ref "wiki/Studio C.md" >}}), and [Studio C HD]({{< ref "wiki/Studio C HD.md" >}}) for downloading showtape content through an internet connection.

<h2> Hardware </h2>
The system is held on a Merkari MX67 SD-WAN unit.<ref>https:<i>meraki.cisco.com/product/security-sd-wan/small-branch/mx67/</ref> The store's iPad is used to control the Navori system wirelessly, which can be used to select the current live show. This is done through an Intranet application that connects to the Navori QL Mobile<ref>https:</i>lsslogin.com/</ref> website.
