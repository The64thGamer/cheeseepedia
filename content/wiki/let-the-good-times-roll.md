...
contributors = ["The 64th Gamer", "Ceclife13", "RedaCEC", "Cyber Snout"]
citations = ["https://archive.org/details/january-1994"]
credits = ["Duncan Brannan - Voice of Chuck E. Cheese, Mr. Munch, Singing Voice of Jasper T. Jowls", "Karlisa Burleson - Voice of Helen Henny", "Annagrey Wiiechman - Singing Voice of Helen Henny", "Bob West - Voice of Jasper T. Jowls, Pasqually The Chef, Show Announcer", "Jeremy Blaido - VJ, Voice of Charlie Rockit", "Robert Gotcher - Mailman, Charlie Chorebot", "Dave Robinson - Programmer"]
...
2. **Segment 1**
    ...
    2.  ['I Heard It Through The Grapevine'](https://en.wikipedia.org/wiki/I_Heard_It_Through_the_Grapevine)
3. **Intermission 2**
    ...
    8.  Trivia
4. **Segment 2**
    1.  ['Achy Breaky Heart'](https://en.wikipedia.org/wiki/Achy_Breaky_Heart)
    2.  ['Proud Mary'](https://en.wikipedia.org/wiki/Proud_Mary)
5. **Intermission 3**
    ...
    10. CEC TV '94 ID
6. **Segment 3**
    1.  ['Freeze Frame'](https://en.wikipedia.org/wiki/Freeze_Frame_(The_J._Geils_Band_album))
    2.  'Dog Jammin''
7. **Intermission 4**
