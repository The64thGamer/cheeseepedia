...
gallery = []
+++
{{Generic|image=Pasq hot line promo art.png|desc=Promotional Art for Pasqually's Hot Line}}

The **_Color Call-out Monitor System**_ (AKA **_Video Call-out System**_, and later called the **_Pasqually Hot Line**_) was [Pizza Time Theatre's]({{< ref "wiki/Pizza Time Theatre.md" >}}) successor to the [NOTALOG]({{< ref "wiki/NOTALOG.md" >}}) system used at the first location, [San Jose, CA (370 S Winchester Blvd)]({{< ref "wiki/San Jose, CA (370 S Winchester Blvd).md" >}}).
