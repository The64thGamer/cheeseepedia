...
4.  **Intermission 2**
    1.  CEC TV ID - 'Janitor'
    2.  Eddie Coker - 'Play With Me' / 'The Dog'
    4.  CEC TV ID - 'Stars'
    5.  CEC TV Classic ID
    6.  Larry The Technician - 'Video Feed'
5.  **Segment 3**
...
- Old MacDonald Training (Studio C)
- Hokey Pokey Training (Studio C)
- Birthday Star Extravaganza (2min) (Studio C)
...
- Larry The Technician is reused from [Studio C Premiere], Singing Cowboy is reused from [April 1999], Eddie Coker - 'The Dog' is reused from [Chuck E's Rockin' Rhymes], VeggieTales - 'Sports Utility Vehicle (SUV) is reused from [CEC TV April 2005 Show], and CEC TV Artist Spotlight is reused from [September 2006 Show].
- "Every Boy, Every Girl' is a remake of a song from [Chuck E. Cheese's 20th Anniversary], with some lyrics being changed to reflect the 30th anniversary.
