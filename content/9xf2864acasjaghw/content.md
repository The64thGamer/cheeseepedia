...
4. **Intermission 3**
    ...
    4. 'Ratings'
    5. 'Drawing Chuck E.'
    6. 'Ken Chuck E. Derby 2'
    7. CEC TV ID - 'Marx Bros'
5. **Segment 3**
    1. 'Chuck E.'s Place'
6. **Intermission 4**
    1. 'Singing Cowboy'
...
NOTE: The standard live shows apart of the main show, are still available at Nanuet, NY, These live shows were only avaliable during the Grand Re-Opening on July 18, 2024.
...
1. 11/21/24 Update - Added Throwback Holiday songs and intermissions, live shows removed.
2. 01/06/25 Update - Reverted to the original show list
...
4. 01/04/26 Update - Reverted to the original show list
5. 03/05/26 Update - 'That's A Deal' is removed
6. 03/19/26 Update - 'That's A Deal' is added.
<br>
    <br>
...
* Before [Birthday Star 2001], Havin' A Party 01, and If You're Happy and You Know It, a portion of the Birthday Break from [January 2001 Show] plays. These live shows would only be used for the Grand Re-Opening.
* Despite all of the songs being programmed in their respective shows, this show has no programming for Studio C, with the animatronic being set to random movements.