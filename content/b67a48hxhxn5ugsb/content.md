The ***Color Call-out Monitor System*** (AKA ***Video Call-out System***, and later called the ***Pasqually Hot Line***) was [Pizza Time Theatre] successor to the [NOTALOG] system used at the first location, [San Jose, CA (370 S Winchester Blvd)].
...
New numbers will flash up in large size on the screen, but unlike NOTLOG, it will only do it for 5 seconds as opposed to 30. Up to 18 displays can be connected to the system.[1]

## Installations

- [Sunnyvale, CA (1247 W El Camino Real)] a store built sometime in 1980.[1]
- [Simi Valley, CA (71 Tierra Rejada Rd)], a store built in late 1980. The system was still in use by 1986 at the store, likely being gutted in its 1990 remodeling.[2]
