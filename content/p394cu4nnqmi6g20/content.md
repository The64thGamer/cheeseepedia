...
- 'Will Frye The Nutrition Guy' is reused from [Studio C Premiere], Super Jasper - 'Staring Contest' is reused from [April 1999], 'Go To Chuck E. Cheese' is reused from the [April 2002 Show], 'Chuck E.'s Place' and Monkey Ninjas - Episode 5 are reused from the [January 2004 Show], 'First Impression' and 'Just Being Me' are reused from the [Chuck E. Cheese April 2004 Show], 'What Up' is reused from [September 2004], 'Firehouse', 'Skateboarding', and 'Keep it Groovin'' are resued from the [January 2005 Show], 'Opposite Day' is reused from the [CEC TV April 2005 Show], Sing-along Guys - 'BINGO' is reused from the [January 2006 Show], and 'The Trashman' is reused from [January 2007].
- The VJ spots in this show feature Matt Daniel. In Segment 5's VJ spot, 'Going On A Diet', a cut song from [September 2004], can be heard in the background.
