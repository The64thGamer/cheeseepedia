...
## Wolfman Zapp Animatronic

An unknown amount of Zapp's locations, possibly all of them, came with a [Wolfman Zapp (Cyberamic)] as their retrofit of the existing Chuck E. Cheese cyberamic character. The animatronic came in multiple styles and iterations, with only the [Reno, NV (651 E Moana Lane)] store being linked to a particular bot given its use in a parade in Reno in 2015. No marketing or interviews ever mention the animatronic, or if any of the other [Cyberamics] made appearances in Zapp's locations. It is also unclear if the animatronic was for display or had a showtape set up, though parts and cosmetics for the bot could be ordered in a catalogue for maintenance, suggesting at least some use of animation.[3]
