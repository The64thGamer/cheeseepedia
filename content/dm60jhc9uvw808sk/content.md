...
- This is the last Evergreen show to include programming signals for Studio C-based systems. Starting with [Chuck E. Cheese Evergreen Show 2023], all programming signals for these systems would be stripped and would only include curtain open/close signals and random movements.
