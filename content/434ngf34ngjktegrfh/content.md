...
* **old.md** is used to show old article versions, which will display in CEP-JS when content.md is empty. This is due to a lot of location pages early on being mass written with no oversight, leading to a lot of unsourced poor quality articles. All locations were thus wiped, but a lot of this data was still valuable to display and keep. This file now resolves that by displaying a warning when its contents are shown, and they are hidden once content.md is written into.
