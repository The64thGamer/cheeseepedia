...
Starting in March 2021 with [Manassas, VA (7730 Stream Walk Ln)], the Dance Floors were updated once again to completely remove the frame, leaving only the interactive display. This design discontinues the use of floodlights and moves the ceiling TVs to the game room. A [Video Wall] now sits directly behind the Dance Floor as part of the character wall. The installation of this version of the Dance Floor required a hole to be dug into the foundation of a store; locations that aren't allowed to do this simply use the 2019 Dance Floor with the [Video Wall] instead, as it can be installed above ground.
