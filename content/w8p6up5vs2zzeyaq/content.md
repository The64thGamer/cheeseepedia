...
In May of 1993, starting with the [Best of CEC TV 1993] showtape, the data placed on the tape would be shifted alongside updating the [3-Stage Control System] EPROM chip to read the shifted data. This would be done to invalidate all previous shows from being played.
