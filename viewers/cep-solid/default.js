...
function J(e, t, n, r, i) {
	...
	if (e = s && n[0] && n[0].parentNode || e, o === "string" || o === "number") {
		...
		if (Y(o, t, n, i)) return v(() => n = J(e, o, n, r, !0)), () => n;
		if (a) {
		...
		} else c ? n.length === 0 ? X(e, o, r) : ae(e, n, o) : (n && Z(e), X(e, o));
		n = o;
	} else if (t.nodeType) {
...
var Q = null;
async function se() {
	return Q ||= await (await fetch("/viewers/cep-solid/compiled-json/titleToFolderIDMap.json")).json(), Q;
}
//#endregion
//#region src/GlobalFunctions.jsx
var ce = /*#__PURE__*/ U("<a><img alt loading=lazy class>", !0, !1, !1);
async function le(e) {
...
//#endregion
//#region src/App.jsx
var me = /*#__PURE__*/ U("<link rel=icon href=/viewers/cep-js/assets/Logos/favicon-cep.ico>"), he = /*#__PURE__*/ U("<link rel=stylesheet href=/viewers/cep-js/main.css>"), $ = /*#__PURE__*/ U("<h1 class=article-title>"), ge = /*#__PURE__*/ U("<div class=infobox><div class=infobox-thumbnail></div><div class=infobox-date>"), _e = /*#__PURE__*/ U("<div>Loading…");
function ve(e) {
	let [t] = b(async () => ({ thumbnailUrl: await pe(await ue(e.pageThumbnailFile)) }));
	return ne(ie, {
		get when() {
			return !t.loading;
		},
		...
		get children() {
			return [
				...
				(() => {
					var t = $();
					return K(t, () => e.title), t;
				})(),
				(() => {
					var n = ge(), r = n.firstChild, i = r.nextSibling;
					return K(r, () => t().thumbnailUrl), K(i, () => e.startDate), n;
				})()
			];
		}
	});
